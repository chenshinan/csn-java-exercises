...
public class FileComparatorTest {
    ...
    private final File original = new File(this.getClass().getResource("/old.txt").getPath());
 
    private final File revised = new File(this.getClass().getResource("/new.txt").getPath());

...
public class TextDiffDTO {
    ...
    List<difflib.Delta<String>> deleteData;
    List<difflib.Delta<String>> insertData;
    List<difflib.Delta<String>> changeData;

    public TextDiffDTO() {
    }

    public TextDiffDTO(List<difflib.Delta<String>> insertData, List<difflib.Delta<String>> deleteData, List<difflib.Delta<String>> changeData) {
